...
\subsection{Equations}
We have the following equations in \cref{fig:mutable-eq} that allow us to ``normalize'' \kw{set} and \kw{get} commands to a sequence of \kw{get}s followed by a sequence \kw{sets}:
