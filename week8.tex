...
\begin{mathpar}
  ...
  {\strut}
  {\memState{\mu \parallel \mapsVal{a}{V}}{\getCmd<a>} \stepsTo \memState{\mu \parallel \mapsVal{a}{V}}{\retEx*{V}}}

  \defrule[D-Set][dyn:set]
  {V \evalsTo[\Sigma] V_0}
  {\memState{\mu \parallel \mapsVal{a}{\_}}{\setCmd<a>{V}} \stepsTo \memState{\mu \parallel \mapsVal{a}{V_0}}{\retEx*{V_0}}}
\end{mathpar}
