...
\begin{mathpar}
\inferrule[$\Pi$-type]{\Gamma \entails A_1 \text{ type} \\ \Gamma, x : A_1 \entails A_2}{\Gamma \entails x : A_1 \rightarrow A_2 \text{ type}}

\inferrule[$\Pi$-I]{\Gamma \entails A_1 \text{ type} \\ \Gamma, x : A, \entails A_2 \text{ type}}{\Gamma \entails \lambda x . M_2 : (x : A_1 \rightarrow A_2)}
...
\begin{mathpar}
\inferrule[]{\Gamma \entails M, N : A}{\Gamma \entails Id_A (M, N) \text{ type}} 
